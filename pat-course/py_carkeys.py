# py_carkeys.py
"""
Let's tell a little story about starting a car.  What can go wrong?

Battery dead?  That happens.  Left the lights on?

More freakish:  the key snaps in the ignition.  Does happen. But
then:  can you get it out and, if so, find a spare?
"""
