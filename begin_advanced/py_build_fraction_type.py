"""
Python has a Fraction class in the standard library
module fractions, however that shouldn't stop us 
from building one, given our knowledge of both 
arithmetic and special names.  Here's an example.
"""
